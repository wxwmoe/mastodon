...
RUN echo "修改字数上限" \
  ...
  && sed -Ei '/#\w{6};/s/;/ !default;/' /opt/mastodon/app/javascript/styles/mastodon/variables.scss \
  ...
  && sed -i "s/9baec8/b5495b/g" /opt/mastodon/app/javascript/styles/mastodon-sakura/variables.scss \
  && sed -i "s/d9e1e8/feeeed/g" /opt/mastodon/app/javascript/styles/mastodon-sakura/variables.scss \
  && sed -i "s/858afa/fccdd3/g" /opt/mastodon/app/javascript/styles/mastodon-sakura/variables.scss \
  && sed -i "s/563acc/f596aa/g" /opt/mastodon/app/javascript/styles/mastodon-sakura/variables.scss \
  && sed -i "s/6364ff/f7a9b9/g" /opt/mastodon/app/javascript/styles/mastodon-sakura/variables.scss \
  && sed -i "s/b0c0cf/fbc3cc/g" /opt/mastodon/app/javascript/styles/mastodon-sakura/variables.scss \
  && sed -i "s/9bcbed/f8c3cd/g" /opt/mastodon/app/javascript/styles/mastodon-sakura/variables.scss \
  ...
  && sed -i "s|light|sakura|" /opt/mastodon/app/javascript/styles/mastodon-sakura.scss /opt/mastodon/app/javascript/styles/mastodon-sakura-topbar.scss /opt/mastodon/app/javascript/styles/mastodon-sakura-bottombar.scss \
  ...
  && sed -i "s/595aff/f596aa/g" /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-single-column.scss /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-multiple-columns.scss \
  && sed -i "s/9388a6/828282/g" /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-single-column.scss /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-multiple-columns.scss \
  && sed -i "s/8c8dff/f4a7b9/g" /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-single-column.scss /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-multiple-columns.scss \
  && sed -i "s/e5e1ed/f7e6e7/g" /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-single-column.scss /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-multiple-columns.scss \
  && sed -i "s/17bf63/86C166/g" /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-single-column.scss /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-multiple-columns.scss \
  && sed -i "s/9588a6/0b1013/g" /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-single-column.scss /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-multiple-columns.scss \
  && sed -i "s/e6e1ed/fedfe1/g" /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-single-column.scss /opt/mastodon/app/javascript/styles/mastodon-bird-ui-sakura/layout-multiple-columns.scss \
