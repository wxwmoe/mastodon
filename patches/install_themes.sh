...
mkdir -p "$bird_ui_tmp"
wget "https://github.com/rollecode/mastodon-bird-ui/archive/refs/tags/4.0.0.tar.gz" -O "$bird_ui_tmp/source.tar.gz"
...
wget "https://github.com/mattbirchler/Tangerine-Neue-for-Mastodon/archive/refs/tags/2.6.5.tar.gz" -O "$tangerine_tmp/source.tar.gz"
